...
class DetailsRoom:
    def __init__(self,root):
        ...
        labelframeleft=LabelFrame(self.root,bd=2,relief=RIDGE,text="Add New Room",font=("arial",12,"bold"),padx=2)
    ...
    def update(self):
        if self.var_floor.get()=="":
            messagebox.showerror("Error","Please Enter Correct Room Number",parent=self.root)
        else:
            conn=mysql.connector.connect(host='localhost',user='root',password='sandip',database='management')
            my_cursor=conn.cursor()
